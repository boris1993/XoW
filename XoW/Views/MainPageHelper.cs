...
namespace XoW.Views
{
    partial class MainPage : Page
    {
        private void InitializeStaticResources()
        {
            ...
            CreateEmoticonButtons(
                NewThreadEmoticonWrapPanel,
                OnNewThreadEmoticonButtonClicked);
            CreateEmoticonButtons(
                NewReplyEmoticonWrapPanel,
                OnNewReplyEmoticonButtonClicked);
        }
        ...
        private async Task RefreshForumsAsync()
        {
            ...
            forumGroups.SelectMany(fg => fg.Forums)
                .ToList()
                .ForEach(
                    f => GlobalState.ForumAndIdLookup.Add(
                        f.Name,
                        (f.Id, f.permissionLevel)));
